...
birthweight %>% 
  ...
  labs(title = "Residuals and Predicted Value of Birthweight", 
       x = "Predicted birthweight (grams)", 
       y = "Residuals")

```

Comparison of my model to 1) one using length at birth and gestational age, 2) one using head circumference, length, sex, and all interactions thereof. 
